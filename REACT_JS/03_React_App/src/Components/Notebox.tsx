...
export default function Notebox({ title, details, date, onDelete }: NoteAttributes) {
    return (
        <div className="w-full max-w-sm max-h-72 p-6 bg-linear-to-b from-rose-50 to-purple-50 rounded-2xl border border-rose-200/80 shadow-sm flex flex-col justify-between group">

function Item() {
    return (
        <div className="itemCard hover:bg-gray-100 bg-white border-b border-slate-300 rounded-xl py-2 px-4 w-full grid grid-cols-8 gap-4 items-center">
            {/* Product Image */}
            <img
                src="https://i.pinimg.com/736x/88/40/c3/8840c3a4db6fc894291dd9b578450244.jpg"
                alt="Hoodie" draggable="false"
            ...
            {/* Product Quantity */}
            <div className="col-span-2 w-fit quantity px-2 py-1 flex items-center gap-3 bg-gray-100/80 rounded-lg border border-gray-200 text-gray-800 font-medium shadow-inner">
            ...
            <button
                ...
                className="removeItem w-fit col-span-1 p-2 rounded-lg text-red-500 hover:bg-red-50 hover:text-red-600 transition-colors active:scale-90">

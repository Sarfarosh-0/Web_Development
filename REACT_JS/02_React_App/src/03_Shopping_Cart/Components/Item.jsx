function Item() {
    return (
        <div className="itemCard py-2 px-4 bg-white w-full flex justify-center gap-10 items-center rounded-xl border border-gray-200 shadow-xl">
            ...
            <div className="itemsDetails flex flex-col  w-36">
            ...
            {/* Product Quantity */}
            <div className="quantity px-2 py-1 flex items-center gap-3 bg-gray-100/80 rounded-lg border border-gray-200 text-gray-800 font-medium shadow-inner">
            ...
            <button
                ...
                className="removeItem p-2 rounded-lg text-red-500 hover:bg-red-50 hover:text-red-600 transition-colors active:scale-90">
